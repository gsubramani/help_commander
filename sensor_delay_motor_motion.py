...
def collect_data(file_name = "sensor_delay.pkl"):
    ...
    command_sinusoidal_torque(hEC,axis = axis, amplitude= 20, frequency=50)
    pause(1)
...
if __name__ == "__main__":
    collect_data(file_name="sensor_delay10_1kbwHZ_4_9.pkl")
    analyse_data(file_name="sensor_delay10_1kbwHZ_4_9.pkl")
