...
hEC.send_parameter(axis, PARAMETER_TORQUE_CLAMP,0, 2.0)
hEC.send_parameter(axis, PARAMETER_VELOCITY_LIMIT,0, 10)
hEC.send_parameter(axis, PARAMETER_VELOCITY_DEADBAND,0, 0.1)


hEC.send_parameter(axis, PARAMETER_POSITION_GAIN,0, 200.0)
hEC.send_parameter(axis, PARAMETER_INTEGRATOR_GAIN,0, 1)
hEC.send_parameter(axis, PARAMETER_INTEGRATOR_CLAMP,0, 1)
hEC.send_parameter(axis, PARAMETER_DAMPING,0, 0.2)


hEC.send_parameter(axis, PARAMETER_INPUT_AMPLITUDE,0, 2)
hEC.send_parameter(axis, PARAMETER_INPUT_FREQUENCY,0, 1)


hEC.send_parameter(axis, PARAMETER_INPUT_SETPOINT,0, 2)
...
some_data = hEC.get_stream_data(32000)
